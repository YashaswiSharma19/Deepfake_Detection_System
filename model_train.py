...
train_data_dir = '/content/drive/MyDrive/img_data/train_img'  #path to the train data
test_data_dir = '/content/drive/MyDrive/img_data/test_img' #path to the test data
