...
A deepfake detection system leveraging AI techniques that detects deepfake images. This app allows users to upload an image and then the model processes the image to detect whether it is 'Real' or 'Fake'.
## Table of Contents
